...
data("barry")
#Fruit and gases
#Aggiunto beta4sum al codice in quanto in questo caso ci sono 4 variabili e non 3
...
#NO CONST OR TREND
cajo<-ca.jo(y_norm,type="eigen",ecdet="none",K=1,spec="longrun",season=NULL,dumvar=NULL)
summary(cajo)
#TREND
