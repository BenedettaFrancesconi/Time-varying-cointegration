...
x1<-as.data.table(read.csv(
  file = "C:/Users/bened/Desktop/Vrije/Lezioni/Dissertation/Dataset/Italy/Usati/FAOSTAT_citrusdata_6-30-2021.csv"
))
...
summary(cajo)
vecm<-VECM(y,2,r=2,include = "none",beta=NULL,estim = "ML")
summary(vecm)
print(vecm)
...
print(vecm)
#CONST
vecmc<-VECM(y_norm,1,r=1,include = "const",beta=NULL,estim = "ML")
summary(vecmc)
print(vecmc)
#BOTH
vecmct<-VECM(y_norm,1,r=1,include = "both",beta=NULL,estim = "ML")
summary(vecmct)
print(vecmct)
toLatex(vecmct)
...
rt<-rank.test(vecmct,type="trace")
summary(rt)
print(rt)
