...
x1<-as.data.table(read.csv(
  file = "C:/Users/bened/Desktop/Vrije/Lezioni/Dissertation/Dataset/Italy/Usati/FAOSTAT_oildata_6-30-2021.csv"
))
...
y <- cbind(y1, y2, y3)
y <- cbind(x1, x2, x3,x4) #Funziona solo quando si usano 3 variabili alla volta
